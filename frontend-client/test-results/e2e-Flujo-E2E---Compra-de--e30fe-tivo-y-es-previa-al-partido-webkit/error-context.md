...
- Location: tests\e2e.spec.ts:111:9
...
Call log:
  ...
  - retrying fill action
    ...
    - navigated to "https://accounts.google.com/v3/signin/identifier?opparams=%253F&dsh=S1025995216%3A1777843740358643&access_type=offline&client_id=787459168867-0v2orf3qo56uocsi84iroseoahhuovdm.apps.googleusercontent.c…"
    - waiting for element to be visible, enabled and editable
...
> 118 |       await passwordInput.fill('password123');
  ...
  146 |         // (Nota: Si el textoFechaPartido no es Date-parseable directamente, requerirá ajuste)
  147 |         expect(fechaDispositivo.getTime()).toBeLessThan(fechaPartido.getTime());
  148 |       }
  149 |     });
  150 |   });
  151 | 
