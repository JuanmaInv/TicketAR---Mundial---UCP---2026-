      ...
      <div className="container max-w-4xl px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600 dark:text-slate-400 font-medium">
            ¿Tienes algún problema con tu compra? Estamos aquí para ayudarte las 24 horas del día.
          </p>
        </div>
        ...
        {enviado ? (
          <div className="glass-panel p-12 rounded-[3rem] text-center bg-white dark:bg-slate-900 border border-emerald-500/30">
            ...
            <p className="text-slate-600 dark:text-slate-400">Hemos recibido tu mensaje. Un agente de TicketAR se pondrá en contacto contigo en los próximos 15 minutos.</p>
            <button 
          ...
          <div className="grid md:grid-cols-3 gap-8">
              ...
              <form onSubmit={manejarEnvio} className="glass-panel p-10 rounded-[3rem] bg-white dark:bg-slate-900 border border-slate-100 dark:border-white/5 shadow-2xl">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div>
                    ...
                    <input type="text" required className="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-2xl text-slate-900 dark:text-white" placeholder="Tu nombre" />
                  </div>
                  <div>
                    <label className="block text-[10px] font-black uppercase tracking-widest text-slate-500 mb-2">Correo Electrónico</label>
                    <input type="email" required className="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-2xl text-slate-900 dark:text-white" placeholder="tu@email.com" />
                  </div>
                </div>
                <div className="mb-6">
                  <label className="block text-[10px] font-black uppercase tracking-widest text-slate-500 mb-2">Asunto</label>
                  <select className="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-2xl text-slate-900 dark:text-white appearance-none">
                    <option>Problema con el Pago</option>
                    <option>Error en la Selección de Asiento</option>
                ...
                <div className="mb-8">
                  <label className="block text-[10px] font-black uppercase tracking-widest text-slate-500 mb-2">Mensaje / Descripción</label>
                  <textarea required className="w-full px-5 py-4 bg-slate-50 dark:bg-slate-800/50 border border-gray-200 dark:border-slate-700 rounded-2xl text-slate-900 dark:text-white h-32" placeholder="Describe tu problema en detalle..."></textarea>
                </div>
            ...
            <div className="md:col-span-1 space-y-6">
              <div className="glass-panel p-8 rounded-[2rem] bg-indigo-600 text-white shadow-xl">
                ...
                <button className="w-full py-3 bg-white text-indigo-600 rounded-xl font-bold text-xs uppercase tracking-widest">Iniciar Chat</button>
              </div>
