...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8 glass-panel p-10 rounded-[2.5rem] border border-gray-100 hover:border-[var(--usa-blue)] transition-colors duration-500 bg-white relative overflow-hidden shadow-xl shadow-slate-200/50">
        ...
        <div className="relative z-10">
          <h2 className="mt-2 text-center text-4xl font-black italic tracking-tighter uppercase text-slate-900">
        ...
        <form className="mt-8 space-y-6 relative z-10" onSubmit={handleLogin}>
          <div className="space-y-5">
            <div>
              ...
              <input
                type="email"
                required
                className="w-full px-5 py-4 bg-slate-50 border border-gray-200 rounded-2xl text-slate-900 placeholder-slate-400 focus:outline-none focus:border-[var(--usa-blue)] focus:ring-1 focus:ring-[var(--usa-blue)] transition-colors"
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center">
              <input
                ...
                name="remember-me"
                type="checkbox"
                className="h-4 w-4 rounded border-gray-300 bg-white text-[var(--usa-blue)] focus:ring-[var(--usa-blue)]"
              />
          ...
          <p className="text-center text-sm text-slate-500 mt-6 border-t border-gray-100 pt-6">
            ¿No tenés cuenta?{" "}
