...
import { getPartidos, getSectores, createTicket, formatPrice, Sector } from "@/lib/api";
      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12">
        ...
        <section className="flex-1">
          <div className="mb-12">
            ...
            <p className="text-slate-600 dark:text-slate-300 font-medium italic mt-2">Sorteo final confirmado para el Mundial 2026.</p>
          </div>
                  ...
                  <div className="group relative bg-card rounded-[3.4rem] overflow-hidden transition-all duration-500 min-h-[350px] flex flex-col md:flex-row shadow-2xl">
                    ...
                    <div className="p-12 relative z-10 w-full flex flex-col justify-between">
                      <div className="flex justify-between items-center mb-8">
                        ...
                        <span className="text-muted text-xs font-bold uppercase italic tracking-widest">{new Date(match.fecha_partido).toLocaleDateString()}</span>
                      </div>
                      ...
                      <div className="flex flex-col lg:flex-row justify-between items-center pt-10 border-t border-border gap-8">
                        ...
                        <div className="flex items-center gap-10">
                          ...
                          <button 
                            ...
                            className={`px-10 py-5 rounded-xl font-black text-xs uppercase tracking-widest transition-all transform hover:scale-105 active:scale-95 shadow-xl flex items-center gap-2 animate-pulse-subtle
                              ${successId === match.id 
