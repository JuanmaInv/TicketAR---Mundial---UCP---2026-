...
export default function MyTicketsPage() {
  return (
    <div className="min-h-[85vh] flex flex-col items-center justify-center py-12 px-4 bg-white">
      <div className="text-center max-w-lg space-y-6">
        ...
        <div className="bg-slate-50 border border-gray-200 rounded-3xl p-10 shadow-lg mt-8 relative overflow-hidden">
          {/* Decoración Tricolor */}
          ...
          <h2 className="text-2xl font-black text-slate-900 mb-2 tracking-tight">Aún no tenés tickets</h2>
